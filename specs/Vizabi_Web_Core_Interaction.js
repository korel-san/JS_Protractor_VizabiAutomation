...
describe('Vizabi tools page automated test', function () {
  ...
  it('should be found Mountain chart', function () {
  ...
  it('should be displayed Mountain chart', function () {
    browser.get(baseUrl + '/tools/mountain');
    browser.wait(EC.visibilityOf(play), 60000, 'Chart is not Loaded');
  ...
  it('should be selected Mountain chart', function () {
    browser.get(baseUrl + '/tools/mountain');
    browser.wait(EC.visibilityOf(play), 60000, 'Chart is not Loaded');
  ...
  it('should be unchecked Mountain chart', function () {
    browser.get(baseUrl + '/tools/mountain');
    browser.wait(EC.visibilityOf(play), 60000, 'Chart is not Loaded');
  ...
  it('Poverty Population', function () {
    browser.get(baseUrl + '/tools/mountain');
    browser.wait(EC.visibilityOf(play), 60000, 'Chart is not Loaded');
  ...
  it('should be found Map chart', function () {
  ...
  it('should be stylished during hovering on Map chart', function () {
